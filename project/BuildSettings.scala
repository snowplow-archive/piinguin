...
object BuildSettings {
  ...
  lazy val clientSettings = Seq(name := "piinguin-client", version := "0.1.0-M3") ++ publishSettings ++ commonSettings ++ clientDependencies
  ...
  lazy val protoGenSettings = Seq(name := "piinguin-protocols", version := "0.1.0-M3") ++ publishSettings ++ basicSettings ++ grpcSources ++ grpcGenDependencies
